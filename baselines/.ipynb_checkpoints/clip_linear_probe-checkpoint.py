...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        choices=["FMoW","COOS","iWildCam","CivilComments","AutoArborist"],
        default="COOS",
        help="Dataset name",
    )
    parser.add_argument(
    ...
    for C in [0.75]:
        train_features, train_labels = get_features(dataset_name=args.dataset_name, split='train', subset_path=None)#args.subset_path)
